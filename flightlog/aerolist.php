...
$aero = array (		// code OACI => FullName , geographic bounds, airfield altitude , password
	...
	'EDAG'=> array('GROSSRUECKERSWALDE',"l.rec='EDAG' AND l.alt < 1370 AND (l.lat BETWEEN 50.64117 AND 50.64721 ) AND (l.lon BETWEEN 13.11849 AND 13.13947)",670,''),
	...
	'UNTER'=> array('Unterwossen',"(l.rec='UWoessen' OR l.rec='UWoessen3') AND l.alt < 1255 AND (l.lat BETWEEN 47.72564 AND 47.73572 ) AND (l.lon BETWEEN 12.42701 AND 12.45022 )",555,''),		
