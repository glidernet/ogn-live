...
$aero = array (
	...
	'EFAH'=> array('AHMOSUO',"l.rec='EFAH' AND l.alt < 729 AND (l.lat BETWEEN 64.89065 AND 64.89964 ) AND (l.lon BETWEEN 25.73859 AND 25.76488)",29,''),
	'EFKE'=> array('KEMI',"l.rec='EFKE' AND l.alt < 719 AND (l.lat BETWEEN 65.76690 AND 65.79713 ) AND (l.lon BETWEEN 24.57764 AND 24.58718)",19,''),
	'EFPU'=> array('PUDASJARVI',"l.rec='EFPU' AND l.alt < 821 AND (l.lat BETWEEN 65.40029 AND 65.40429 ) AND (l.lon BETWEEN 26.92068 AND 26.98352)",121,''),
	'EFRA'=> array('RAUTAVAARA',"l.rec='EFRA' AND l.alt < 845 AND (l.lat BETWEEN 63.41672 AND 63.43499 ) AND (l.lon BETWEEN 28.10459 AND 28.13562)",145,''),
	'EFRH'=> array('RAAHE',"l.rec='EFRH' AND l.alt < 736 AND (l.lat BETWEEN 64.68603 AND 64.69056 ) AND (l.lon BETWEEN 24.67706 AND 24.71353)",36,''),
	'EFSO'=> array('SODANKYLA',"l.rec='EFSO' AND l.alt < 883 AND (l.lat BETWEEN 67.38511 AND 67.40498 ) AND (l.lon BETWEEN 26.61228 AND 26.62596)",183,'')
	);
