...
$aero = array (
	...
	'YARA'=> array('ARARAT',"l.rec='YARAT' AND l.alt < 1007 AND (l.lat BETWEEN -37.31600 AND -37.30625) AND (l.lon BETWEEN 142.98359 AND 142.99805)",307,''),
	...
	'YHSM'=> array('HORSHAM',"l.rec='YHSM' AND l.alt < 836 AND (l.lat BETWEEN -36.68016 AND -36.66788) AND (l.lon BETWEEN 144.187050 AND 144.168372)",136,''),
	...
	'YRYW'=> array('RAYWOOD',"l.rec='YHSM' AND l.alt < 836 AND (l.lat BETWEEN -36.54578 AND -36.53215) AND (l.lon BETWEEN 142.24043 AND 142.24184)",136,''),
